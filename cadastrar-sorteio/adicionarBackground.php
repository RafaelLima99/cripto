    ...
    <div class="row">
        ...
        <?php } ?>
            <div class="card shadow mb-5 rounded mt-4">
                ...
                <div class="card-body">
                    <form action="../app/Actions/adicionarBackgroundAction.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="backgound-file" class="form-label weight-600">Background:</label>
                            <input class="form-control" type="file" id="backgound-file" name="backgound-file" required>
                        </div>
